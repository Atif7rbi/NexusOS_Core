...
export const enUS: TranslationDictionary = {
  ...
  "crm.success.converted": "Conversion successful.",
  "crm.success.followUp": "Follow-up updated successfully.",
  ...
  "crm.cards.openLeads": "Open leads",
  "crm.cards.overdueFollowUps": "Overdue follow-ups",
  "crm.cards.todayFollowUps": "Today follow-ups",
  "crm.cards.unassignedLeads": "Unassigned leads",
  "crm.cards.monthlyConversions": "Monthly conversions",
  "crm.cards.lostInPeriod": "Lost in selected period",
  ...
  "crm.filters.lifecycle": "Lead lifecycle",
  "crm.filters.allLifecycle": "All lifecycle states",
  "crm.filters.followUpState": "Follow-up state",
  "crm.filters.allFollowUpStates": "All follow-up states",
  "crm.filters.scheduledLater": "Scheduled later",
  "crm.filters.dateFrom": "Follow-up date from",
  "crm.filters.dateTo": "Follow-up date to",
  "crm.lifecycle.open": "Open",
  "crm.lifecycle.won": "Won",
  "crm.lifecycle.lost": "Lost",
  "crm.queue.title": "Daily follow-up queue",
  "crm.queue.all": "All leads",
  "crm.queue.overdue": "Overdue",
  "crm.queue.today": "Today",
  "crm.queue.tomorrow": "Tomorrow",
  "crm.queue.thisWeek": "This week",
  "crm.queue.unscheduled": "Unscheduled",
  "crm.view.list": "List",
  "crm.view.pipeline": "Pipeline",
  "crm.pipeline.emptyStage": "No leads in this stage",
  ...
  "crm.activity.followUpScheduled": "Follow-up scheduled",
  "crm.activity.followUpRescheduled": "Follow-up rescheduled",
  "crm.activity.followUpCompleted": "Follow-up completed",
  "crm.activity.followUpCancelled": "Follow-up cancelled",
  ...
  "crm.followUp.schedule": "Schedule follow-up",
  "crm.followUp.reschedule": "Reschedule",
  "crm.followUp.complete": "Complete follow-up",
  "crm.followUp.cancel": "Cancel follow-up",
  "crm.followUp.scheduleTitle": "Schedule a follow-up",
  "crm.followUp.scheduleDescription": "Choose the follow-up time and next action.",
  "crm.followUp.rescheduleTitle": "Reschedule follow-up",
  "crm.followUp.rescheduleDescription": "Update the follow-up time or next action.",
  "crm.followUp.completeTitle": "Complete follow-up",
  "crm.followUp.completeDescription": "The current follow-up will be closed and recorded in the activity timeline.",
  "crm.followUp.cancelTitle": "Cancel follow-up",
  "crm.followUp.cancelDescription": "The current follow-up will be cancelled while preserving its history.",
  "crm.followUp.date": "Follow-up time",
  "crm.followUp.actionType": "Next action",
  "crm.followUp.actionNote": "Action details",
  "crm.followUp.closeNote": "Optional note",
  "crm.followUp.dateRequired": "Follow-up time is required.",
  "crm.followUp.dateInvalid": "The follow-up time is invalid.",
  "crm.followUp.otherNoteRequired": "Action details are required when Other is selected.",
  "crm.nextAction.call": "Call",
  "crm.nextAction.whatsapp": "WhatsApp",
  "crm.nextAction.meeting": "Meeting",
  "crm.nextAction.site_visit": "Site visit",
  "crm.nextAction.send_offer": "Send offer",
  "crm.nextAction.waiting_response": "Waiting for response",
  "crm.nextAction.other": "Other",
  ...
  "crm.dialog.convertMatchFound": "A customer with the same phone number was found:",
  "crm.dialog.convertMatchStatus.customer": "Active customer",
  "crm.dialog.convertMatchStatus.inactive": "Inactive customer",
  "crm.dialog.convertMatchStatus.lead": "Legacy lead — will be promoted to customer on confirm",
