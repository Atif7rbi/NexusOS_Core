...
return new class extends Migration
{
    ...
    {
        DB::unprepared(<<<'SQL'
            CREATE FUNCTION public.prevent_accounting_source_type_mutation() RETURNS trigger
            ...
            CREATE FUNCTION public.prevent_accounting_settings_mutation() RETURNS trigger
            LANGUAGE plpgsql SET search_path=pg_catalog,public AS $$ BEGIN
            ...
            CREATE FUNCTION public.prevent_activated_tenant_currency_change() RETURNS trigger
            LANGUAGE plpgsql SET search_path=pg_catalog,public AS $$ BEGIN
            ...
            CREATE FUNCTION public.enforce_account_hierarchy() RETURNS trigger
            ...
            CREATE FUNCTION public.enforce_account_lifecycle_and_history() RETURNS trigger
            LANGUAGE plpgsql SET search_path=pg_catalog,public AS $$
            ...
            CREATE FUNCTION public.prevent_account_delete() RETURNS trigger LANGUAGE plpgsql SET search_path=pg_catalog,public AS $$ BEGIN RAISE EXCEPTION USING ERRCODE='55000',MESSAGE='accounts cannot be deleted'; END $$;
            ...
            CREATE FUNCTION public.enforce_accounting_period_nonoverlap() RETURNS trigger
            LANGUAGE plpgsql SET search_path=pg_catalog,public AS $$ BEGIN
              PERFORM 1 FROM public.accounting_settings WHERE tenant_id=NEW.tenant_id FOR UPDATE;
            ...
            CREATE FUNCTION public.enforce_accounting_period_mutation() RETURNS trigger
            LANGUAGE plpgsql SET search_path=pg_catalog,public AS $$ BEGIN
            ...
            CREATE FUNCTION public.prevent_accounting_period_delete() RETURNS trigger LANGUAGE plpgsql SET search_path=pg_catalog,public AS $$ BEGIN RAISE EXCEPTION USING ERRCODE='55000',MESSAGE='accounting periods cannot be deleted'; END $$;
            ...
            CREATE FUNCTION public.enforce_journal_entry_insert() RETURNS trigger
            LANGUAGE plpgsql SET search_path=pg_catalog,public AS $$ BEGIN
            ...
            CREATE FUNCTION public.enforce_journal_entry_mutation() RETURNS trigger
            LANGUAGE plpgsql SET search_path=pg_catalog,public AS $$
            ...
            CREATE FUNCTION public.enforce_journal_entry_delete() RETURNS trigger LANGUAGE plpgsql SET search_path=pg_catalog,public AS $$ BEGIN
            ...
            CREATE FUNCTION public.validate_system_journal_final_state() RETURNS trigger LANGUAGE plpgsql SET search_path=pg_catalog,public AS $$ BEGIN
            ...
            CREATE FUNCTION public.enforce_journal_line_parent_state() RETURNS trigger
